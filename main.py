...
connect = sqlite3.connect(r'C:/Users/739329/OneDrive - New College Swindon/Session task/healthA.db', check_same_thread=False)



connect.execute('CREATE TABLE IF NOT EXISTS user (id INTEGER NOT NULL PRIMARY KEY autoincrement, username VARCHAR NOT NULL UNIQUE, '
